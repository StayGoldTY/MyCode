...
(function ($/*document*/) {
    ...
    // SVG (ie8 with adobe viewer (not functional but avoids crash), ie9+ & everyone else) or HTML?
    var oScriptContainer = ($.firstChild == "[object SVGSVGElement]" || $.firstChild.toString() == "[object SVGSVGElement]" || $.toString() == "[object SVGDocument]") ? $.firstChild : $.getElementsByTagName("head").item(0);
    ...
    */
    jdata.fetch = (function () {
        ...
        return function (sResource, fnCallback/* (json) */, bUseCache) {
            ...
            var oScript;
            // SVG (ie8 with adobe viewer (not functional but avoids crash), ie9+ & everyone else)
            if ($.firstChild == "[object SVGSVGElement]" || $.firstChild.toString() == "[object SVGSVGElement]" || $.toString() == "[object SVGDocument]") {
